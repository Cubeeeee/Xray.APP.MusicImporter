...
namespace Xray.APP.Impoter.Platform
{
    ...
    /// Q音
    /// </summary>
    public class Impoter_MusicQQ : Impoter_Base
    {
        ...
        public override List<IMusicInfo> SearchMusic(params object[] parms)
        {
            ...
            //标准头
            HttpItem item = new HttpItem();
            item.URL = $"https://c.y.qq.com/soso/fcgi-bin/client_search_cp?ct=24&qqmusic_ver=1298&new_json=1&remoteplace=txt.yqq.song&searchid=58936722416423872&t=0&aggr=1&cr=1&catZhida=1&lossless=0&flag_qc=0&p=1&n=10&w=%E8%B4%A5%E5%B0%86&g_tk_new_20200303=1293094193&g_tk=1293094193&loginUin=462247201&hostUin=0&format=json&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq.json&needNewCode=0";
            item.UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.61 Safari/537.36";
            item.Referer = "https://y.qq.com/portal/profile.html";
            item.ContentType = "application/x-www-form-urlencoded";
            item.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
